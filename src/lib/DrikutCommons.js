...
// Menu
// ================================================================================================================
export function DrikutMenu({ githubUser }) {
  ...
  return (
    <DrikutMenu.Wrapper isMenuOpen={isMenuOpen}>
      ...
      <DrikutMenuProfileSidebar githubUser={githubUser} />
    </DrikutMenu.Wrapper>
  )
}
...
function DrikutMenuProfileSidebar({ githubUser }) {
  return (
    <div className="drikutMenuProfileSidebar">
      <div>
...
// ================================================================================================================
export function DrikutProfileSidebarMenuDefault() {
  return (
    <DrikutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
